...
///
/// Inbound messages arrive via HTTP POST on a local listener. Outbound replies
/// are optionally forwarded to a configured URL, which makes this a useful
/// bridge for custom systems without a first-class native channel adapter.
